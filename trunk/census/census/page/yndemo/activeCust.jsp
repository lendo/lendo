	...
	<tbody>
		...
		<tr>
				...
				<tbody>
					<tr>
						...
						<table align="center" width="80%">
							<tbody>
								<tr>
									<td align="center"><b><span id="body:myform:title">活动客户分布</span></b></td>
								</tr>
							</tbody>
						</table>
						</td>
						...
						<table borderColor="silver" class="datatable" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<th height="25" colspan="2">活动客户</th>
							...
							<tbody>
								...
								<tr bgcolor="#FFFFFF">
									<td height="25" class="alignleft">机构1012</td>
									<td height="25" class="alignright"><a href="custList.jsp">50</a></td>
									<td height="25" class="alignright"><a href="custList.jsp">42</a></td>
									<td height="25" class="alignright">83.23</td>
									<td height="25" class="alignright"><a href="custList.jsp">11</a></td>
									<td height="25" class="alignright">42.23</td>
									<td height="25" class="alignright"><a href="custList.jsp">18</a></td>
									<td height="25" class="alignright">89.34</td>
									<td height="25" class="alignright"><a href="custList.jsp">75</a></td>
									<td height="25" class="alignright">82.34</td>
								</tr>
			...
			<input type="hidden" name="body:myform_SUBMIT" value="1" /><input
				...
				name="body:myform:_link_hidden_" />
	</form>
			</td>
		</tr>
		<tr>
