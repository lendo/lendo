				...
				<tbody>
					<tr>
						...
						<table align="center" width="80%">
							<tbody>
								<tr>
									<td align="center"><b><span id="body:myform:title">电子渠道交易列表</span></b></td>
								</tr>
							</tbody>
						</table>
						</td>
						...
						<table borderColor="silver" class="datatable" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<th height="25">交易渠道</th>
									<th height="25">交易日期</th>
									<th height="25">交易时间</th>
							...
							<tbody>
								<tr bgcolor="#FFFFFF">
									...
									<td height="25" class="alignright">速汇通</td>
									<td height="25" class="alignright">网上银行</td>
									<td height="25" class="alignright">20070315</td>
									<td height="25" class="alignright">18:20:35</td>
									<td height="25" class="alignright">0000000001</td>
									<td height="25" class="alignright">0000000001</td>
									<td height="25" class="alignright">0000000001</td>
									<td height="25" class="alignright">人民币</td>
									<td height="25" class="alignright">1000.00</td>
									<td height="25" class="alignright">成功</td>
									<td height="25" class="aligncenter"><a href="transInfo.jsp">查看</a></td>
								</tr>
								<tr bgcolor="#FFFFFF">
									<td height="25" class="alignleft">张三</td>
									<td height="25" class="alignright">速汇通</td>
